          ...
          <div className="">
            <div className="">
                ...
                <div  ref={conponentPDF} className=" bordre border-collapse border-2  border-slate-700 pb-2">
                  ...
                  <table className=" w-full ">
                    <thead className="bg-[#151B54] w-full text-white">
                      <tr>
                        <th className=" text-[0.41rem] p-0 sm:px-2 px-1 lg:p-1 sm:text-base  border border-slate-300">
                          Sr. No
                        </th>
                        <th className=" text-[0.41rem] p-0 sm:px-3 px-1 lg:p-1 sm:text-base  border border-slate-300">
                          Enq id
                        </th>
                        <th className=" text-[0.41rem] p-0 sm:px-3 px-1 lg:p-1 sm:text-base  border border-slate-300">
                          {" "}
              ...
              <div className="d-grid d-md-flex justify-content-md-end mb-3">
                <button
                  className="btn btn-success bg-blue-400 py-2 px-2 w-28 text-xl mt-10 rounded-lg text-white "
                  onClick={generatePDF}
                >
                  Print
                </button>
