  ...
  return (
    <>
      <div className="flex flex-col gap-4 bg-white mb-10">
        <h2 id="heading">Vehicle enquiry </h2>
        <div className="mainForm">
          ...
          <Card hoverable bodyStyle={{ padding: "0" }}>
            ...
            <Form layout="vertical" autoComplete="off" onFinish={saveData}>
              <h3 className="card_menu"> VEHICLE DETAILS</h3>
              ...
              <Form.Item
                ...
                <Col className="select_option_col">
                  <Form.Item
                    name="from"
                    label={<label style={{ fontSize: "15px" }}>from</label>}
                    rules={[
                      {
                        required: true,
                ...
                <Col className="select_option_col">
                  <Form.Item
                    name="to"
                    label={<label style={{ fontSize: "15px" }}>To </label>}
                    rules={[
                      {
                        required: true,
